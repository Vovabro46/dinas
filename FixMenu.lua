...
function Library:AddDropdown(tab, name, options, defaultOption, callback)
    ...
    -- Исправление: Создаем ScreenGui если его нет
    local screenGui = self.ScreenGui or self.MainFrame.Parent
    ...
    local function updateListSize()
        ...
        dropdownList.Size = UDim2.new(0, buttonAbsoluteSize.X, 0, maxHeight)
